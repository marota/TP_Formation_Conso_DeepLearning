...
#afficher le nom des colonnes de Xinput_scaled ici
...
def newKerasModel(nInputs,nOutput=1, hLayers = None):
    ...
    """
    ############## TO DO = 1ligne
    ##créer vous un modèle sequentiel avec Keras. 
    model = None
    ###########
    if(hLayers==None):
    ...
    for l in range(nHiddenLayers-1):
        ############## TO DO = 1ligne
        ##ajouter de nouvelles couches aux reseau de neurones avec la taille des couches que vous avez précisé dans hLayers. 
